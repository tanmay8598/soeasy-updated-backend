...
const email = function ({ dueDate, type, balanceDue, company, link, id }) {
...
@media only screen and (max-width: 600px) {
  ...
  invoice-link {
    ...
    Number(balanceDue) <= 0 ? "" : moment(dueDate).format("MMM Do YYYY")
      ...
      <div class"footer">
          <a href="https://ixtminds.com">
          <img class="footer-logo" src="https://ixtminds.com/wp-content/uploads/2022/08/cropped-new-logo-1-141x63.png"/>
        </a>
      </div>
    <p style="text-align: center">Powered by ©IXT Minds</p>
    </div>
    </body>
</html>`;
};
